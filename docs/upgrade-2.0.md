...
gemini-3.8-flash и 30–36 у «-fast» Astra/Sol (у тех «fast» — про очередь). Контекст 128k, картинки. На него переведены субагенты,
чистка стенограмм, письма научного брифа, классификаторы обещаний/долгов и дайджест; чат — Astra, длинные конспекты — Astra 1M.
