...
хранилище нет. Лечение: `"session": {"dmScope": "per-peer"}` + рестарт гейтвея. Побочный
эффект: чат возвращается в старую личную сессию, накопленный после апгрейда контекст
общей сессии остаётся только в `recall`.
